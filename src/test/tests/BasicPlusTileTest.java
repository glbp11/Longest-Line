...
public class BasicPlusTileTest {

    private Connection c;
    private Connection c1;
    private List connections;
    private Icon plusIcon;
    private BasicPlusTile t;
    ...
    public void beforeEachTest(){
        ...
        connections.add(c);
        connections.add(c1);
        plusIcon = new ImageIcon("PlusTileIcon.png");
        t = new BasicPlusTile("PlusTile",connections,plusIcon);
    }
    ...
    public void testDuplicateTile() {
        ...
        assertEquals(dup.getName(),"PlusTile");
